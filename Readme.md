...
v2.0.0  
移動する対象のアイテム全体の時間にかけてのイージングを決めることができるようになる設定の追加

v2.1.0  
テキストのパスのオプションにて、密度をイージングのUIによって決めることができるようになる設定の追加  
イージングのUIを変更した際に、UndoRedoに登録されるように修正
